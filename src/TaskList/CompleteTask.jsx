...
const CompleteTask = ({data}) => {
  return (
    <div className='p-5 flex-shrink-0 h-full rounded-xl w-[425px] bg-green-400'>
        ...
        <div className='mt-10'>
          <button className='w-full bg-green-500 py-2 font-medium px-2 text-sm rounded-md'>Completed</button>
        </div>
      </div>
    )
}
